...
(library Library_1
	...
	(compDef "1N5819HW-7-F" (originalName "1N5819HW-7-F") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		...
		(attr "Arrow Part Number" "1N5819HW-7-F")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/1n5819hw-7-f/diodes-incorporated?utm_currency=USD&region=nac")
		(attr "Description" "Diode Schottky 1A 40V SOD123 Diodes Inc 1N5819HW-7-F, SMT Schottky Diode, 40V 1A, 2-Pin SOD-123")
		(attr "<Hyperlink>" "https://www.diodes.com//assets/Datasheets/1N5819HW.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "1N5819HW-7-F.stp")
