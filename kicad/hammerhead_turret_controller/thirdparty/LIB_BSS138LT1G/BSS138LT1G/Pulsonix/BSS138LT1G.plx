...
//224525/1805047/2.50/3/2/MOSFET N-Channel
...
(library Library_1
	...
	(symbolDef "BSS138LT1G" (originalName "BSS138LT1G")
	...
	(compDef "BSS138LT1G" (originalName "BSS138LT1G") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "BSS138LT1G"))
		...
		(attr "Manufacturer_Part_Number" "BSS138LT1G")
		(attr "Mouser Part Number" "863-BSS138LT1G")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/onsemi/BSS138LT1G?qs=vNc2DXHODiKPZ2y3rQhTYQ%3D%3D")
		(attr "Arrow Part Number" "BSS138LT1G")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/bss138lt1g/on-semiconductor?utm_currency=USD&region=europe")
		(attr "Description" "Low Threshold Voltage; Miniature SOT-23 Surface Mount Package; RoHS Compliant")
		(attr "<Hyperlink>" "https://www.onsemi.com/pub/Collateral/BSS138LT1-D.PDF")
		(attr "<Component Height>" "1.11")
		(attr "<STEP Filename>" "BSS138LT1G.stp")
