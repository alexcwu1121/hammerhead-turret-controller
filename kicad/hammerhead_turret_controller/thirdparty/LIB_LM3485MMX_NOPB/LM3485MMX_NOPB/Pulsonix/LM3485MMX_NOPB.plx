...
//318988/1805047/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LM3485MMX_NOPB" (originalName "LM3485MMX_NOPB")
	...
	(compDef "LM3485MMX_NOPB" (originalName "LM3485MMX_NOPB") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "ISENSE") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "PGATE") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "PWR GND") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "ADJ") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM3485MMX_NOPB"))
		...
		(attr "Manufacturer_Part_Number" "LM3485MMX/NOPB")
		(attr "Mouser Part Number" "926-LM3485MMX/NOPB")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LM3485MMX-NOPB?qs=X1J7HmVL2ZGdhzJdAW27lw%3D%3D")
		(attr "Arrow Part Number" "LM3485MMX/NOPB")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/lm3485mmxnopb/texas-instruments?utm_currency=USD&region=nac")
		(attr "Description" "4.5-35V, Hysteretic Non-Synchronous PFET Buck Controller")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/lm3485")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "LM3485MMX_NOPB.stp")
