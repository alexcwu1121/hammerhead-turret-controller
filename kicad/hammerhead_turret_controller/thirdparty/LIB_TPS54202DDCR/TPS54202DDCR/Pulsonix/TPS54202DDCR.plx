...
//333750/1805047/2.50/6/3/Power Supply
...
(library Library_1
	...
	(symbolDef "TPS54202DDCR" (originalName "TPS54202DDCR")
	...
	(compDef "TPS54202DDCR" (originalName "TPS54202DDCR") (compHeader (numPins 6) (numParts 1) (refDesPrefix PS)
		)
		(compPin "1" (pinName "GND") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "2" (pinName "SW") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Output))
		...
		(compPin "4" (pinName "FB") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Input))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS54202DDCR"))
		...
		(attr "Manufacturer_Part_Number" "TPS54202DDCR")
		(attr "Mouser Part Number" "595-TPS54202DDCR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS54202DDCR?qs=uP22XH7NdCsJtN%2Fq54jCtQ%3D%3D")
		(attr "Arrow Part Number" "TPS54202DDCR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tps54202ddcr/texas-instruments?utm_currency=USD&region=nac")
		(attr "Description" "4.5V to 28V Input, 2A Output, EMI Friendly Synchronous Step-Down Converter")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tps54202")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TPS54202DDCR.stp")
